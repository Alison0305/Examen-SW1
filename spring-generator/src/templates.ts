...
export const templates = Object.freeze({
  settings: readTemplate("settings"), build: readTemplate("build"), properties: readTemplate("application-properties"), application: readTemplate("application"), corsConfig: readTemplate("cors-config"),
