...
El sistema SHALL derivar el propietario exclusivamente del JWT autenticado y SHALL permitir crear, leer y actualizar un proyecto solo a su propietario.
...
- **THEN** el sistema devuelve el proyecto.

#### Scenario: Acceso ajeno
- **WHEN** otro usuario solicita o actualiza el proyecto
